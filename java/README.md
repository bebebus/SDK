...
零第三方依赖的 Java 客户端，覆盖商户支付 OpenAPI 全部 **13 个签名端点**，实现 HMAC-SHA256 请求签名与回调验签。
...
| 可用国家 | `countriesQuery` | `/merchant/countries/query` | pay |
...
| `QueryExample.java` | 查单 / 余额 / 支付方式 / 国家 / 收据（inline 演示） |
